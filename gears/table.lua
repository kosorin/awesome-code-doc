...
function M.crush(target, source, raw) end
...
function M.iterate(t, filter, start) end
...
---@param source table #The source table. Its values will be copied into `target`.
---@return table # The `target` table.
function M.merge(target, source) end
...
---    )
---
function M.diff_merge(target, new, identifier, merger) end
