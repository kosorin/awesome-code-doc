...
---@param s screen|nil # The screen whose wallpaper should be set. Can be nil, in which case all screens are set.
---@param background color|hex_color|_gears.color|nil # The background color that should be used. Gets handled via gears.color. The default is black.
---@param scale number|nil The scale factor for the wallpaper. Default is 1 (original size).
---@deprecated
