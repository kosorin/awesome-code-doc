...
---@return string|nil # A randomly selected filename from the specified path (with a specified extension if required) or `nil` if no suitable file is found. If `absolute_path` is set, then a path is returned instead of a file name.
