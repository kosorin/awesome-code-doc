...
---@deprecated
function M.request_name(bus, name) end
...
---@deprecated
function M.disconnect_signal(bus, path, interface, method, type_1st_arg, value_1st_arg, type_2nd_arg, value_2nd_arg) end
